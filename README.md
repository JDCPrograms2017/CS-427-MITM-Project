...
We found that the flipper zeros evil twin attack created unsecured SSID's which make it so our phones would not automaticaly connect to it. This caused us to use the mini PC to create our access point with the correct configurations enabling our phones to automaticaly connect when the legitamate access point was deathed. 
